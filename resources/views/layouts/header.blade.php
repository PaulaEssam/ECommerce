        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{url('')}}" class="logo">
                    <img src="{{$getSystemSettingApp->getLogo()}}" alt="Logo" width="105" height="25">
                </a>
                                                ...
                                                @foreach($categories as $cat)
                                                    @if (!empty($cat->getSubCategory->count()))
                                                        <div class="col-md-4" style="margin-bottom: 20px;">
                                                            <a href="{{url($cat->slug)}}" class="menu-title">{{$cat->name}}</a><!-- End .menu-title -->
                                                            <ul>
                ...
                <div class="dropdown cart-dropdown">
                    <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                        <i class="icon-shopping-cart"></i>
                            {{-- paymentControllerموجود في ال  Cart كلاس ال  --}}
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-cart-products">
                                ...
                                @foreach (Cart::getContent() as $header_cart)
                                    @php
                                        $product = App\Models\Product::find($header_cart->id);
                                    @endphp
                                        @if(!empty($product))
                                            <div class="product">
