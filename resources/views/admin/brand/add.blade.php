...
@section('title')
<title>Add Brand - E-commerce</title>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form action="{{route('insert_brand')}}" method="post">
                        @csrf
                    <div class="card-body">
                        ...
                        <input type="text" class="form-control" required name="slug" placeholder="Brand Slug Ex. URL">
                        </div>
